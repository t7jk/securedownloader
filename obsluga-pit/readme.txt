...
Wtyczka umożliwia księgowym wgrywanie plików PDF PIT-11, a podatnikom ich pobieranie po weryfikacji danych osobowych.
...
1. Prześlij folder `obsluga-pit` do katalogu `/wp-content/plugins/`
